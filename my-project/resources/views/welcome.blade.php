  ...
  <div class="main-wrapper">
    ...
    <div class="my-5">
      <div class="ai-section p-4 text-white">
        ...
        <p class="fs-5">Khaad ya kide se fasal kharab ho rahi hai? Pareshan na hon! Bas apne bimar paudhe ya patte ki ek
          saaf photo kheche aur yahan upload karein. Hamara AI turant bimari ka naam aur usko thik karne ka sasta ilaj
          bata dega.</p>
        <div class="ai-upload-box text-center">
          ...
          <input type="file" accept=".jpg,.jpeg,.png" class="form-control d-inline-block w-auto mx-auto"
