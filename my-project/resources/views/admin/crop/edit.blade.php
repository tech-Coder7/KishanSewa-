...
@section('admincontent')
    ...
    <main class="main">
        ...
        <div class="form-card">
          ...
          <form action="{{ route('admin.crop.update', $crop->id) }}" method="POST" class="category-form" enctype="multipart/form-data">
                                        ...
                                        <div class="input-icon">
                                            ...
                                            <select id="parent_id" name="categories_id"
                                                ...
                                                @foreach($parentCategories ?? [] as $parent)
                                                    <option value="{{ $parent->id }}" {{ $crop->categories_id == $parent->id ? 'selected' : '' }}>
                                                        {{ $parent->name }}
                                                        @if($parent->parent)
                                                            ({{ $parent->parent->name }})
                                                        @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-icon">
                                        ...
                                        <input type="text" id="title" name="title"
                                            ...
                                            placeholder="Title" value="{{ $crop->title }}">
                                    </div>
                                    @error('title')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-icon">
                                        ...
                                        <input type="text" id="slug" name="slug"
                                            ...
                                            placeholder="auto-generated from name" value="{{ $crop->slug }}">
                                    </div>
                                    @error('slug')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-icon">
                                        ...
                                        <select id="status" name="status"
                                            ...
                                            <option value="1" {{ $crop->status == '1' ? 'selected' : '' }}>
                                                ✅ Active
                                            </option>
                                            <option value="0" {{ $crop->status == '0' ? 'selected' : '' }}>
                                                ❌ Inactive
                                            </option>
                                        </select>
                                    </div>
                        ...
                        <div class="form-group-box" id="container">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="editor" name="content"
                                    ...
                                    placeholder="Enter detailed content about this crop...">{{ $crop->content }}</textarea>
                                @error('content')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
