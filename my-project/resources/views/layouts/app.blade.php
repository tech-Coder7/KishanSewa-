            ...
            <div class="collapse navbar-collapse" id="menu">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link {{ request()->routeIs('vegetable.*') ? 'active' : '' }}"
                            href="{{ route('vegetable.index') }}">
                            🌾 Crops & Vegetables
                        </a>
                    </li>
    ...
    <footer class="main-footer">
        <div class="footer-container">
            <div class="footer-column brand-info">
                ...
                <p class="brand-desc">Smart Agriculture System jo desh ke kisaano ko aadhunik takneek, sahi jankari aur
                    naye avsaron se jodkar unhe samriddh banata hai.</p>
