        ...
        <div class="row g-4">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="team-card">
                    ...
                    <p>25 saalon ka kisan, ab 3 lakh kisaanon ki aawaaz. Ground-level insights laate hain platform par.
                    </p>
                    <div class="mt-2">
                        <a href="#" class="me-2" style="color:var(--gold);"><i class="fab fa-linkedin"></i></a>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="team-card">
                    ...
                    <p>Google aur Flipkart ki ex-engineer. Platform ki poori technology stack aur architecture sambhalti
                        hain.</p>
                    <div class="mt-2">
                        <a href="#" class="me-2" style="color:var(--gold);"><i class="fab fa-linkedin"></i></a>
                        <a href="#" style="color:var(--gold);"><i class="fab fa-github"></i></a>
