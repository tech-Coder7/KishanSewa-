...
<head>
  ...
  <style>
    ...
    body { background: var(--bg-color); color: var(--text-color); margin: 0; padding: 0; }
    .text-gold { color: var(--gold); }
    .btn-gold { background-color: var(--gold); color: #1e2f1e; font-weight: 600; border: none; }
    .btn-gold:hover { background-color: #fcc94b; color: #1e2f1e; transform: scale(1.03); }
    ...
    .about-hero p { font-size: 1.15rem; max-width: 650px; margin: 0 auto; opacity: 0.9; }
    ...
    .stat-box:hover { transform: translateY(-5px); box-shadow: 0 10px 25px var(--shadow); }
    .stat-number { font-size: 2.2rem; font-weight: 700; color: var(--dark-green); }
    .stat-label { font-size: 0.9rem; color: #5a7a5a; font-weight: 500; }
    ...
    .mission-block:hover { transform: translateX(4px); box-shadow: 0 8px 20px var(--shadow); }
    .mission-block h4 { font-weight: 700; }
    ...
    .value-card:hover { transform: translateY(-6px); box-shadow: 0 12px 30px var(--shadow); border-color: var(--gold); }
    .value-card i {
      font-size: 2rem; color: var(--gold);
      background: #f9b81b20; padding: 0.6rem;
      border-radius: 14px; margin-bottom: 0.8rem;
      display: inline-block;
    }
    .value-card h5 { font-weight: 600; }
    .value-card p { font-size: 0.93rem; color: #5a7a5a; margin: 0; }
    ...
    .team-card:hover { transform: translateY(-6px); box-shadow: 0 12px 30px var(--shadow); border-color: var(--gold); }
    .team-avatar {
    ...
    .team-card h5 { font-weight: 700; margin-bottom: 0.2rem; }
    .team-card .role { color: var(--gold); font-size: 0.88rem; font-weight: 600; margin-bottom: 0.5rem; }
    .team-card p { font-size: 0.9rem; color: #5a7a5a; }
    ...
    .timeline-item h6 { font-weight: 700; margin-bottom: 0.2rem; }
    .timeline-item p { font-size: 0.92rem; color: #5a7a5a; margin: 0; }
    ...
    .partner-logo:hover { border-color: var(--gold); transform: scale(1.04); }
    .partner-logo i { display: block; font-size: 1.8rem; color: var(--gold); margin-bottom: 0.4rem; }
...
<div class="container py-5">
  ...
  <div class="about-hero">
    ...
    <p class="mt-3">KishanSewa ek smart agriculture platform hai jo desh ke hardworking kisaanon ko technology, sahi jankari aur government schemes se jodta hai — taaki har khet mein khushhali ho.</p>
    <div class="mt-4 d-flex gap-3 justify-content-center flex-wrap">
      <a href="#mission" class="btn btn-gold rounded-pill px-5 py-2"><i class="fas fa-bullseye"></i> Hamara Mission</a>
      <a href="#team" class="btn btn-outline-light rounded-pill px-5 py-2"><i class="fas fa-users"></i> Hamari Team</a>
    </div>
  </div>
    ...
    <div class="row g-4">
      <div class="col-md-6">
        <div class="mission-block">
          ...
          <p class="mt-2">Har ek kisan ko smart technology, real-time data aur expert guidance available karana — chahe wo UP ke gaon mein ho ya Maharashtra ke khet mein. Technology ka faida sabhi tak pahunchana hamara mission hai.</p>
          <ul class="mt-3 ps-3">
      ...
      <div class="col-md-6">
        <div class="mission-block" style="border-left-color: #2e7d32;">
          ...
          <p class="mt-2">2030 tak Bharat ke 5 crore kisaanon ko ek digital platform par laana jahan wo apni fasal, khet aur income ko smartly manage kar sakein — aur apne bachon ko ek behtar bhavishya de sakein.</p>
          <ul class="mt-3 ps-3">
  ...
  <div class="mb-5" id="team">
    ...
    <p class="text-muted mb-4">Jo log har din khet se lab tak kaam karte hain taaki aapki zindagi behtar ho.</p>
    <div class="row g-4">
      <div class="col-sm-6 col-lg-3">
        <div class="team-card">
          ...
          <p>IIT Kanpur aur 15 saal ki agri-tech experience ke saath Rajesh ne KishanSewa ki neev rakhi.</p>
          <div class="mt-2">
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="team-card">
          <div class="team-avatar">👩‍🔬</div>
          <h5>Dr. Anita Sharma</h5>
          <div class="role">Chief AI Officer</div>
          <p>IISc Bangalore se PhD. Crop disease AI model aur smart recommendation engine ki architect.</p>
          <div class="mt-2">
            <a href="#" class="me-2" style="color:var(--gold);"><i class="fab fa-linkedin"></i></a>
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="team-card">
          <div class="team-avatar">👨‍🌾</div>
          <h5>Sunil Patel</h5>
          <div class="role">Head of Farmer Relations</div>
          <p>25 saalon ka kisan, ab 3 lakh kisaanon ki aawaaz. Ground-level insights laate hain platform par.</p>
          <div class="mt-2">
            <a href="#" class="me-2" style="color:var(--gold);"><i class="fab fa-linkedin"></i></a>
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="team-card">
          ...
          <p>Google aur Flipkart ki ex-engineer. Platform ki poori technology stack aur architecture sambhalti hain.</p>
          <div class="mt-2">
            <a href="#" class="me-2" style="color:var(--gold);"><i class="fab fa-linkedin"></i></a>
            <a href="#" style="color:var(--gold);"><i class="fab fa-github"></i></a>
          </div>
  ...
  <div class="mb-5">
    <div class="row g-4 align-items-start">
      ...
      <div class="col-lg-7">
        ...
        <!-- Contact CTA -->
        <div class="mt-4 p-4 rounded-4 text-white" style="background: linear-gradient(135deg, #1e3a2b, #14301e); border-left: 5px solid var(--gold);">
          <h5><i class="fas fa-phone-alt text-gold me-2"></i>Hamse Jude</h5>
          <p class="mb-3" style="opacity: 0.85;">Kisaanon ke liye free helpline — koi bhi sawaal, koi bhi problem.</p>
