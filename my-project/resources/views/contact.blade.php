...
<head>
  ...
  <title>KishanSewa · Contact Us</title>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-1">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"><i class="fas fa-home"></i> Home</a>
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"><i class="fas fa-info-circle"></i> About</a>
          <ul class="dropdown-menu">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"><i class="fas fa-seedling"></i> Crops</a>
          <ul class="dropdown-menu">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"><i class="fas fa-cogs"></i> Services</a>
          <ul class="dropdown-menu">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"><i class="fas fa-file-signature"></i> Schemes</a>
          <ul class="dropdown-menu">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle active" href="#" data-bs-toggle="dropdown"><i class="fas fa-envelope"></i> Contact</a>
          <ul class="dropdown-menu">
  ...
  <div class="container">
    <div class="row g-4">
      <div class="col-md-6 col-lg-3">
        ...
        <div>
          <i class="fab fa-google social-icon" style="font-size:1.8rem; margin-right:0.8rem; color:var(--gold); cursor:pointer;"></i>
          <i class="fab fa-facebook social-icon" style="font-size:1.8rem; margin-right:0.8rem; color:var(--gold); cursor:pointer;"></i>
          <i class="fab fa-instagram social-icon" style="font-size:1.8rem; margin-right:0.8rem; color:var(--gold); cursor:pointer;"></i>
          <i class="fab fa-youtube social-icon" style="font-size:1.8rem; margin-right:0.8rem; color:var(--gold); cursor:pointer;"></i>
        </div>
      </div>
      <div class="col-md-6 col-lg-3">
