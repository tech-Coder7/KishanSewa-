...
body.dark-mode .service-card .icon-wrap {
    background-color: #2a4d3a !important;
}

body.dark-mode .service-card .icon-wrap i {
    color: var(--icon-color) !important;
}

body.dark-mode .mt-5.p-4 {
    background: #1a2f1e !important;
    border-color: #2a4d3a !important;
}

body.dark-mode .mt-5.p-4 .text-muted {
    color: #bdd3ae !important;
}
...
body.dark-mode .service-card:hover .icon-wrap {
    background: var(--gold);
}

body.dark-mode .service-card:hover .icon-wrap i {
    color: #1e2f1e;
}
    ...
    <div class="mt-5 p-4 rounded-4" style="background: #f9b81b10; border: 1px solid var(--gold);">
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="text-muted mb-0">हमारी किसान हेल्पलाइन पर कॉल करें: <strong>1800-180-1551</strong> (टोल-फ्री)
                </p>
            </div>
